...
/**
 * Raised when a system permission is revoked from an application.
 * Raise khi một quyền hệ thống bị thu hồi khỏi application.
 */
public record SystemPermissionRevokedEvent(
